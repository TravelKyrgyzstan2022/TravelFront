              ...
              <div className={stay.full_card}>
                ...
                <div className={stay.card_right}>
                  ...
                  <div className={stay.card_txt}>
                    <p>
                      Lörem ipsum lanektiga monovåfasm att nipyn eunas misiska
                      bev fast ose supraktig: bena rer. Bens kontrapatologi div
                      eunera, lådade utom dyde oren i oss apide epifydovis så
                      derad. Sehösade tinar serad dianener i antiv i kesynisade
                      innan nygol mellanförskap.
                    </p>
                  </div>
            ...
            <div className={stay.card}>
              <div className={stay.full_card}>
                ...
                <div className={stay.card_right}>
                  ...
                  <div className={stay.card_txt}>
                    <p>
                      Set in Alamedin, 26 km from Tash-Tyube, Supara Chunkurchak
                      offers accommodation with a restaurant, free private
                      parking, a fitness centre and a bar. 27 km from
                      Vorontsovskoye and 30 km from Këk-Dzhar, the property
                      features a garden and a terrace. The accommodation
                      provides a 24-hour front desk, airport transfers, room
                      service and free WiFi.
                    </p>
                  </div>
                  <div className={stay.tags_and__btn}>
                    <button className={stay.arrow_next2}>
                      <ArrowForwardIcon />
                    </button>
                  </div>
                  <div className={stay.card_button}>
            ...
            <div className={stay.card}>
              <div className={stay.full_card}>
                ...
                <div className={stay.card_right}>
                  ...
                  <div className={stay.card_txt}>
                    <p>
                      Cheap but the same time very comfortable and warm hostel
                      in the centre of Bishkek.
                    </p>
                  </div>
                  <div className={stay.tags_and__btn}>
                    <button className={stay.arrow_next3}>
                      <ArrowForwardIcon />
                    </button>
                  </div>
                  <div className={stay.card_button}>
