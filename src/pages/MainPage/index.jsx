    ...
    <div className={main.cards}>
                <div className={main.card}>
                    ...
                    <div className={main.pin}>
                        ...
                        <a className={main.locatioon}><img src={Location} alt="" /> <p>Chuy Region</p></a>
                        </div>
                        ...
                        <div className={main.distribute}>
                            <button className={main.distribute_btn} href="">Easy</button>
                    </div>
                    <div className={main.card_button}>
                        <button className={main.btn}><img className={main.btn_img} src={Plan} alt="img" />Add to my trip plan</button>
                    </div>
                </div>
                ...
                <div className={main.card}>
                    ...
                    <div className={main.pin}>
                        ...
                        <div className={main.distribute}>
                            <button className={main.distribute_btn2} href="">Normal</button>
                    </div>
                    <div className={main.card_button}>
                        <button className={main.btn}><img className={main.btn_img} src={Plan} alt="img" />Add to my trip plan</button>
                    </div>
                ...
                <div className={main.card}>
                    ...
                    <div className={main.pin}>
                        ...
                        <div className={main.distribute}>
                            <button className={main.distribute_btn3} href="">Hard</button>
                    </div>
                    <div className={main.card_button}>
                        <button className={main.btn}><img className={main.btn_img} src={Plan} alt="img" />Add to my trip plan</button>
                    </div>
            ...
            <p className={main.articles_txt1} >5 Reasons to Visit Kyrgyzstan</p>
            </div>
                    </div>
                    <div className={main.art_card}>
            <img className={main.articles_card2} src={Horse} alt="" />
            <div className={main.art_txt}>
            <p className={main.articles_txt2}>Fun Activities Everyone Should Try While in Kyrgyzstan</p>
            </div>
                    </div>
                    <div className={main.art_card}>
            <img className={main.articles_card3}  src={Burana} alt="" />
            <div className={main.art_txt}>
            <p className={main.articles_txt3}>7 Interesting Facts About Kyrgyzstan</p>
                    </div>
                    </div>
                    <div className={main.art_card}>
            <img className={main.articles_card4}  src={Transport} alt="" />
            <div className={main.art_txt}>
            <p className={main.articles_txt4}>Transportation System in Kyrgyzstan - Handy Lifehacks</p>
            </div>
                    </div>
        </div>
                </div>
                ...
                <div className={main.stay}>
                    ...
                    <div className={main.pin}>
                        <div className={main.location}>
                        <a className={main.locatioon}><img src={Location} alt="" /> <p>Bishkek</p></a>
                        </div>
                        <div className={main.raiting}>
                            <img src={Star} alt="" />
                            <p className={main.raiting_txt}>4.5</p>
...
{/* ! TRIP */}
                ...
                <div className={main.extrime_tour}>
                    ...
                    <div className={main.pin}>
                        <div className={main.location}>
                        <a className={main.locatioon}><img src={Location} alt="" /> <p>Naryn Region</p></a>
                        </div>
                        <div className={main.raiting}>
                            <img src={Star} alt="" />
                ...
                <div className={main.card}>
                    ...
                    <div className={main.pin}>
                        <div className={main.location}>
                        <a className={main.locatioon}><img src={Location} alt="" /> <p>Issyk-Kul Region</p></a>
                        </div>
                        <div className={main.raiting}>
                            <img src={Star} alt="" />
